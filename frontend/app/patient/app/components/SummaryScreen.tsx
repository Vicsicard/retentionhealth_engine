    ...
    <div className="min-h-screen bg-gradient-to-b from-white to-gray-50 p-6">
      <div className="max-w-2xl mx-auto">
        ...
        <div className="mb-8">
          ...
          <div className="text-body mb-3 font-semibold text-gray-900">{data.header}</div>
          <p className="text-base text-gray-700 mb-3">{data.normalization}</p>
          <p className="text-base text-gray-600">{data.todayGoal}</p>
        </div>
        ...
        {data.nausea_protocol && (
          <div className="card mb-6 bg-blue-50 border-blue-200">
            <h2 className="text-lg font-semibold text-gray-900 mb-4">{data.nausea_protocol.title}</h2>
            <ul className="focus-list">
        ...
        {data.safety_line && (
          <div className="card mb-6 bg-yellow-50 border-yellow-300">
            ...
            <p className="text-sm text-gray-800">{data.safety_line}</p>
          </div>
        )}

        {/* Protein Modifier */}
        <div className="card mb-6">
          <h2 className="text-lg font-semibold text-gray-900 mb-4">{data.protein_modifier.title}</h2>
        ...
        <div className="card mb-6 bg-green-50 border-green-200">
          ...
          <p className="text-sm text-gray-700">{data.encouragement}</p>
        </div>
